...
OCCASIONS = [
    ...
    mk_occasion('weekday_morning', '06:00:00', '09:00:00', range(5)),
    mk_occasion('weekday_evening', '18:00:00', '23:59:59', range(5)),
    
    mk_occasion('weekend_morning', '07:00:00', '09:00:00', range(5)),
    mk_occasion('weekend_evening', '18:00:00', '23:59:59', range(5)),
